package com.klinker.android.launcher.info_page.widgets.swipe_refresh_layout;
 ...
 */
public class OffsetSwipeRefreshLayout extends ViewGroup {
    ...
    private final Animation mAnimateToStartPosition = new Animation() {
        ...
        public void applyTransformation(float interpolatedTime, Transformation t) {
            ...
            setTargetOffsetTopAndBottom(offset - mOffset);
        }
    };
    ...
    private final Runnable mReturnToStartPosition = new Runnable() {
        ...
        public void run() {
            ...
            animateOffsetToStartPosition(mCurrentTargetOffsetTop + mOffset + getPaddingTop(),
     ...
     * @param attrs
     */
    public OffsetSwipeRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void ensureTarget() {
        ...
        if (mTarget == null) {
            ...
            mOriginalOffsetTop = mTarget.getTop() + getPaddingTop() + mOffset;
        }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        final int childTop = getPaddingTop();//mCurrentTargetOffsetTop + getPaddingTop();
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        if (isEnabled() && !mReturningToStart && !mScroll.canScrollVertically(-1)) {
    ...
    private void setTargetOffsetTopAndBottom(int offset) {
        mTarget.offsetTopAndBottom(offset + mOffset);
        mCurrentTargetOffsetTop = mTarget.getTop() + offset;
    }
