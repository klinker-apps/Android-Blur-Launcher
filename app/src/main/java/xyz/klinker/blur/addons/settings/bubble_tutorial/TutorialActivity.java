package xyz.klinker.blur.addons.settings.bubble_tutorial;
...
public class TutorialActivity extends Activity {
    ...
    public static final String ACTION_HIGHLIGHT_PAGE_PICKER = "xyz.klinker.blur.tutorial.PAGE_PICKER";
    public static final String ACTION_START_HIGHLIGHT_DISPLAY = "xyz.klinker.blur.tutorial.DISPLAY";
    public static final String ACTION_HIGHLIGHT_HELP = "xyz.klinker.blur.tutorial.HELP";
